...
const Intro = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { id: "svgintro", className: "intro-section  w-full m-0 p-4 sm:p-0", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "intro text-left mt-4 sm:mt-0", ref: introRef, style: { opacity: 0 }, children: [
...
const Experience = () => {
  ...
  return (
    ...
    /* @__PURE__ */ jsxs("section", { className: "experience-section text-left w-full opacity-0", ref: experienceRef, children: [
...
const certificate_3 = "/assets/certificate_3-D5M6e8A6.webp";
const certificate_4 = "/assets/certificate_4-B9YzwZKQ.webp";
const Certificates = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col w-full opacity-0", ref: certificatesRef, children: [
...
const Proj1 = () => {
  return /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-8", children: [
      /* @__PURE__ */ jsx("h2", { children: "Project 1" }),
      /* @__PURE__ */ jsx("p", { children: "Details about Project 1..." })
    ] })
  ] });
};
const Proj2 = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h2", { children: "Project 2" }),
    /* @__PURE__ */ jsx("p", { children: "Details about Project 2..." })
  ] });
};
const Proj3 = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h2", { children: "Project 3" }),
    /* @__PURE__ */ jsx("p", { children: "Details about Project 3..." })
  ] });
};
const Proj_4 = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h2", { children: "Project 4" }),
    /* @__PURE__ */ jsx("p", { children: "Details about Project 4..." })
  ] });
};
const Proj5 = () => {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h2", { children: "Project 5" }),
    /* @__PURE__ */ jsx("p", { children: "Details about Project 5..." })
  ] });
};
const Projects = () => {
  const projectsRef = useGsapReveal(3);
  const workItems = [
    {
      id: "proj1",
      link: "/Projects/Proj1",
  ...
  return /* @__PURE__ */ jsxs("section", { className: "projects-section flex flex-col w-full opacity-0", ref: projectsRef, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "projects-grid grid grid-cols-1 md:grid-cols-2 gap-x-4", children: workItems.map((item, index) => /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("a", { href: item.link, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsx(
          Work,
          {
            ...item,
...
const arrow = "/assets/arrow-BghEKuGK.svg";
const Contact = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "contact-section flex h-28 flex-col w-full opacity-0", ref: contactRef, children: [
    ...
    workItems.map((item, index) => /* @__PURE__ */ jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsx("h2", { className: "thank-you-message py-20 text-start text-3xl ", children: "👋 Thank you." })
  ] });
};
const Layout = () => {
